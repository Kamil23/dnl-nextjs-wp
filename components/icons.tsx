// Inline SVG icons replacing the FontAwesome + react-share packages.
// Brand paths come from Simple Icons (CC0); the rest are hand-drawn
// strokes. Every icon inherits the text color via currentColor.

type IconProps = { className?: string };

const brand = (path: string) =>
  function BrandIcon({ className = "w-4 h-4" }: IconProps) {
    return (
...
export const PinterestIcon = brand(
...
export function CartIcon({ className = "w-4 h-4" }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M2 3h2.5l2.4 12.2a2 2 0 0 0 2 1.6h8.7a2 2 0 0 0 2-1.6L21.5 7H5.1" />
    </svg>
  );
}
